package ebike.infrastructure.idgenerator;
...
public class IDGeneratorService implements IIDGeneratorService, DomainService {
    ...
    public IDGeneratorService(long nodeId, long customEpoch) {
    ...
    public IDGeneratorService(long nodeId) {
