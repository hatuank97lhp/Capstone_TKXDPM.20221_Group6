...
public class StationListReturn extends JPanel {
    private ApplicationUI applicationUI;

    public StationListReturn(ApplicationUI applicationUI) {
        super();
    ...
    public void init() {
        ...
        var title = new JLabel("Select station to return");
        ...
        for (var i = 0; i < docks.size(); i += 2) {
            ...
            for (var j = i; j <= i + 1; j++) {
                ...
                var viewBtn = new JButton("Return");

                viewBtn.addActionListener(e -> {
                    applicationUI.changeToReturnBikePreview(dock.id);
                });
